...
description: Execute implementation using available subagents for parallel task execution
prev_step: steps/step-02b-tasks.md
next_step: steps/step-04-validate.md
---

# Step 3t: Execute with parallel subagents
...
Coordinate available subagents to implement independent tasks in parallel,
acting as the integration lead.
...
<critical>
IMPORTANT: Use only the subagent tools exposed by the current environment.
Do not require Claude Code feature flags or edit user settings.

...
Retrieve current documentation and code examples using the connected Context7
tools when available.

If the connector is unavailable, use the Context7 CLI without installing it
globally:
...
Do not modify the user's global npm installation just to look up documentation.
